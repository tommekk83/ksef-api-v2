...
class SessionInvoices
{
     ...
     */
    public function list(string $referenceNumber, ?string $xContinuationToken = null, ?int $pageSize = null, ?Options $options = null): Operations\GetApiV2SessionsReferenceNumberInvoicesResponse
    {
     ...
     * @throws \Intermedia\Ksef\Apiv2\Models\Errors\APIException
     */
    public function getStatus(string $referenceNumber, string $invoiceReferenceNumber, ?Options $options = null): Operations\GetApiV2SessionsReferenceNumberInvoicesInvoiceReferenceNumberResponse
    {
