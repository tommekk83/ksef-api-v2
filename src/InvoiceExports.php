...
class InvoiceExports
{
     ...
     */
    public function getStatus(string $operationReferenceNumber, ?Options $options = null): Operations\GetApiV2InvoicesExportsOperationReferenceNumberResponse
    {
