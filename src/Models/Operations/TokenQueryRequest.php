...
class TokenQueryRequest
{
     ...
     *
     *
     * @var ?Components\AuthorIdentifierType $authorIdentifierType
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=authorIdentifierType')]
    public ?Components\AuthorIdentifierType $authorIdentifierType = null;
     ...
     * @param  ?Components\AuthorIdentifierType  $authorIdentifierType
     * @param  ?int  $pageSize
     * @param  ?string  $xContinuationToken
     * @phpstan-pure
     */
    public function __construct(?array $status = null, ?string $description = null, ?string $authorIdentifier = null, ?Components\AuthorIdentifierType $authorIdentifierType = null, ?int $pageSize = null, ?string $xContinuationToken = null)
    {
        $this->status = $status;
