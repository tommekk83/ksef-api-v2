...
class QuerySubunitPermissionsResponse
{
     ...
     * Lista uprawnień.
     *
     * @var array<SubunitPermission> $permissions
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('permissions')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Intermedia\Ksef\Apiv2\Models\Components\SubunitPermission>')]
    ...
    /**
     * @param  array<SubunitPermission>  $permissions
     * @param  bool  $hasMore
     * @phpstan-pure
     */
