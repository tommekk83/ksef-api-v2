...
class AuthenticationOperationStatusResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(\DateTime $startDate, AuthenticationMethod $authenticationMethod, StatusInfo $status, ?bool $isTokenRedeemed = null, ?\DateTime $lastTokenRefreshDate = null, ?\DateTime $refreshTokenValidUntil = null)
    {
