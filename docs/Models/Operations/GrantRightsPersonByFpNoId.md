...
| `idDocument`                                                                         | [Operations\GrantRightsIdDocument](../../Models/Operations/GrantRightsIdDocument.md) | :heavy_check_mark:                                                                   | Dane dokumentu tożsamości osoby fizycznej.                                           |