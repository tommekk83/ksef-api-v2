...
<!-- UsageSnippet language="php" operationID="post_/api/v2/sessions/online" method="post" path="/api/v2/sessions/online" -->
```php
declare(strict_types=1);
...
$request = new Operations\PostApiV2SessionsOnlineRequest(
    formCode: new Operations\PostApiV2SessionsOnlineFormCode(
        systemCode: 'FA (3)',
        schemaVersion: '1-0E',
        value: 'FA',
    ),
    encryption: new Operations\PostApiV2SessionsOnlineEncryption(
...
| Parameter                                                                                              | Type                                                                                                   | Required                                                                                               | Description                                                                                            |
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| `$request`                                                                                             | [Operations\PostApiV2SessionsOnlineRequest](../../Models/Operations/PostApiV2SessionsOnlineRequest.md) | :heavy_check_mark:                                                                                     | The request object to use for the request.                                                             |

### Response

**[?Operations\PostApiV2SessionsOnlineResponse](../../Models/Operations/PostApiV2SessionsOnlineResponse.md)**
...
<!-- UsageSnippet language="php" operationID="post_/api/v2/sessions/batch" method="post" path="/api/v2/sessions/batch" -->
```php
declare(strict_types=1);
...
$request = new Operations\PostApiV2SessionsBatchRequest(
    formCode: new Operations\PostApiV2SessionsBatchFormCode(
        systemCode: 'FA (2)',
        schemaVersion: '1-0E',
        value: 'FA',
    ),
    ...
    encryption: new Operations\PostApiV2SessionsBatchEncryption(
...
| Parameter                                                                                            | Type                                                                                                 | Required                                                                                             | Description                                                                                          |
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `$request`                                                                                           | [Operations\PostApiV2SessionsBatchRequest](../../Models/Operations/PostApiV2SessionsBatchRequest.md) | :heavy_check_mark:                                                                                   | The request object to use for the request.                                                           |

### Response

**[?Operations\PostApiV2SessionsBatchResponse](../../Models/Operations/PostApiV2SessionsBatchResponse.md)**
